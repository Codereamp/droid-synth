...
Java_com_codereamp_synthesizer_android_AndroidGlue_start(JNIEnv *env,
...
extern "C" JNIEXPORT void JNICALL
Java_com_codereamp_synthesizer_android_AndroidGlue_shutdown(JNIEnv *env,
    jobject thiz) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_codereamp_synthesizer_android_AndroidGlue_sendMidi(JNIEnv *env,
...
extern "C" JNIEXPORT void JNICALL
Java_com_codereamp_synthesizer_android_AndroidGlue_setPlayState(JNIEnv *env,
